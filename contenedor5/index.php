...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Trash - Contenedor 5</h1></center><br>
...
<script type="text/javascript">					
    ...
    series: [{
        name: 'Contenedor',
        data: [2, 2, 2, 15, 15, 17, 18,19,6,6,3,5]
    }]
});
	...
	setInterval(function () {
		...
		// Temperatura
		if (chartTmp) {
			$.getJSON('/Smart Trash/contenedor5/php/newdata.php',function(data)
				{
	...
	setInterval(function () {
		$.getJSON('/Smart Trash/contenedor5/php/firedata.php',function(data)
			{
			fme = data[0].fire;
