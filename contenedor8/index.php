...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Trash - Contenedor 8</h1></center><br>
...
<script type="text/javascript">					
    ...
    series: [{
        name: 'Contenedor',
        data: [2, 2, 12, 11, 14, 12, 2,2,17,12,11,2]
    }]
});
	...
	setInterval(function () {
		...
		// Temperatura
		if (chartTmp) {
			$.getJSON('/Smart Trash/contenedor8/php/newdata.php',function(data)
				{
	...
	setInterval(function () {
		$.getJSON('/Smart Trash/contenedor8/php/firedata.php',function(data)
			{
			fme = data[0].fire;
