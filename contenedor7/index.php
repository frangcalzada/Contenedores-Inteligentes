...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Trash - Contenedor 7</h1></center><br>
...
<script type="text/javascript">					
    ...
    series: [{
        name: 'Contenedor',
        data: [10,12, 12, 7, 5, 4, 5,2,10,12,11,12]
    }]
});
	...
	setInterval(function () {
		...
		// Temperatura
		if (chartTmp) {
			$.getJSON('/Smart Trash/contenedor7/php/newdata.php',function(data)
				{
	...
	setInterval(function () {
		$.getJSON('/Smart Trash/contenedor7/php/firedata.php',function(data)
			{
			fme = data[0].fire;
