...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Trash - Contenedor 2</h1></center><br>
...
<script type="text/javascript">					
    ...
    series: [{
        name: 'Contenedor',
        data: [2, 5, 15, 1, 10, 8, 3,9,4,2,1,2]
    }]
});
	...
	setInterval(function () {
		...
		// Temperatura
		if (chartTmp) {
			$.getJSON('/Smart Trash/contenedor2/php/newdata.php',function(data)
				{
	...
	setInterval(function () {
		$.getJSON('/Smart Trash/contenedor2/php/firedata.php',function(data)
			{
			fme = data[0].fire;
