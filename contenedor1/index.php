...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Trash - Contenedor 1</h1></center><br>
...
<script type="text/javascript">					
	...
	setInterval(function () {
		...
		// Temperatura
		if (chartTmp) {
			$.getJSON('/Smart Trash/contenedor1/php/newdata.php',function(data)
				{
	...
	setInterval(function () {
		$.getJSON('/Smart Trash/contenedor1/php/firedata.php',function(data)
			{
			fme = data[0].fire;
