...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Trash - Contenedor 6</h1></center><br>
...
<script type="text/javascript">					
    ...
    series: [{
        name: 'Contenedor',
        data: [1, 10, 2, 5, 7, 4, 9,9,10,4,6,7]
    }]
});
	...
	setInterval(function () {
		...
		// Temperatura
		if (chartTmp) {
			$.getJSON('/Smart Trash/contenedor6/php/newdata.php',function(data)
				{
	...
	setInterval(function () {
		$.getJSON('/Smart Trash/contenedor6/php/firedata.php',function(data)
			{
			fme = data[0].fire;
