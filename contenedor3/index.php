...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Trash - Contenedor 3</h1></center><br>
...
<script type="text/javascript">					
    ...
    series: [{
        name: 'Contenedor',
        data: [4, 6, 6, 7, 5, 8, 15,10,1,5,6,2]
    }]
});
	...
	setInterval(function () {
		...
		// Temperatura
		if (chartTmp) {
			$.getJSON('/Smart Trash/contenedor3/php/newdata.php',function(data)
				{
	...
	setInterval(function () {
		$.getJSON('/Smart Trash/contenedor3/php/firedata.php',function(data)
			{
			fme = data[0].fire;
